...
SECRET_KEY = 'django-insecure-7n)udg2@(3s^dcv@rezb&fs@%=m5p_#3l#1ahobpqbpal$a5j%'
...
'default': {
        ...
        [
            ...
            {'name': 'insert',
             'items': ['Html5video','Html5audio','Image', 'Flash', 'Table', 'HorizontalRule', 'Smiley', 'SpecialChar', 'PageBreak', 'Iframe']},
